...
\begin{column}{0.5\textwidth}
     ...
     \begin{tikzpicture}
            ...
            \node [
                above right,
                inner sep = 0,opacity=1,] (image) at (0,0) {\includegraphics[width=0.8\textwidth]{kthgraphics/KTH-logo.pdf}};
...
\begin{frame}
  ...
  %\begin{center}
  %\begin{tabular}[c]{M{0.33\textwidth}  M{0.33\textwidth} M{0.33\textwidth}}
  %  \includegraphics[width=0.25\textwidth]{kthgraphics/KTH-logo.pdf} &
  %  \includegraphics[width=0.3\textwidth]{logos/vinnova_logo.png} &
  %  \includegraphics[width=0.25\textwidth]{logos/ERC_logo.png}\\
  %  &\includegraphics[width=0.3\textwidth]{logos/naiss.jpeg}&
  %  \includegraphics[width=0.25\textwidth]{logos/nffp.png}
  %\end{tabular}
  %  \vfill
